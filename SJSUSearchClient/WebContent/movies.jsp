	...
	<nav><!-- top nav -->
		<div class="menu">
			<ul>
				...
				<li><a href="restaurants.jsp">Restraunts</a></li>
	...
	<section id="main"><!-- #main content -->
			...
			<div id="search_container">
				...
				<fieldset id="search_box">
						...
						<p id="search_mat">
							<form name="myform" method="post" action="movies"  onsubmit="return validate()">
							<center><label for "search_box" id="search_label"><h1>Enter a Movie/Theatre:
