	...
	<nav><!-- top nav -->
		<div class="menu">
			<ul>
				...
				<li><a href="restraunts.jsp">Restaurants</a></li>
	...
	<section id="main"><!-- #main content -->
			...
			<div id="search_container">
				...
				<fieldset id="search_box">
						...
						<p id="search_mat">
						<form name="myform" method="post" action="restraunts"  >
							<center><label for "search_box" id="search_label"><h1>Enter a Name of a Restaurant:
										<input type="text" name="restraunt">
